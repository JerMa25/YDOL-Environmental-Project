...
// GET  /api/produits/categories        → liste catégories
...
export const CATEGORIES = [
  { id: "tous",         label: "Tous les produits", emoji: "🛒",  color: "#16a34a" },
  { id: "plastique",    label: "Plastique",          emoji: "♻️",  color: "#0ea5e9" },
  { id: "metal",        label: "Métal / Ferraille",  emoji: "⚙️",  color: "#64748b" },
  { id: "papier",       label: "Papier / Carton",    emoji: "📦",  color: "#d97706" },
  { id: "verre",        label: "Verre",              emoji: "🍶",  color: "#06b6d4" },
  { id: "organique",    label: "Compost / Organique",emoji: "🌱",  color: "#16a34a" },
  { id: "electronique", label: "Électronique",       emoji: "💻",  color: "#7c3aed" },
  { id: "textile",      label: "Textile",            emoji: "👕",  color: "#ec4899" },
  { id: "bois",         label: "Bois",               emoji: "🪵",  color: "#92400e" },
];
...
export const PRODUITS_MOCK = [
  ...
  {
    id: "p4",
    nom: "Bouteilles verre brun (lot 100)",
    categorie: "verre",
    prix: 90,
    unite: "lot",
    stockDisponible: 52,
    description: "Lot de 100 bouteilles en verre brun 75 cl, rincées et triées. Pour brasseries, conserveries ou artisans.",
    details: "Contenance : 75 cl. Couleur : brun. Bouchon : non fourni. Nettoyage : rinçage eau froide. Minimum : 1 lot.",
    image: "🍶",
  ...
  },
  {
    ...
    details: "Maturité : 3 mois de compostage. pH : 6.5–7.5. Matière organique : >40%. Idéal : potagers, arbres fruitiers.",
    image: "🌱",
  ...
  },
  {
    ...
    unite: "lot 10kg",
    stockDisponible: 18,
    description: "Composants électroniques de récupération : cartes mères, processeurs, câbles cuivre. Pour réparateurs et recycleurs.",
    details: "Composition variable. Matériaux nobles : cuivre, aluminium, or traces. Dépollution : carte lithium retirée.",
    image: "💻",
  ...
  },
  {
    ...
    details: "Dimensions moyennes : 120×10×2 cm. Essence : mélange (pin, iroko). Clous retirés. Non traité chimiquement.",
    image: "🪵",
...
export const COMMANDES_MOCK = [
  {
    ...
    statut: "livré",
    items: [
      { produitId: "p5", nom: "Compost organique mûr",     quantite: 3,  prixUnit: 500, unite: "sac 20kg", image: "🌱" },
  ...
  },
  {
    ...
    items: [
      ...
      { produitId: "p4", nom: "Bouteilles verre brun (lot)", quantite: 2, prixUnit: 90,  unite: "lot", image: "🍶" },
    ],
    adresseLivraison: "Rue des Palmiers Nr 12, Bastos, Yaoundé",
    fraisLivraison: 1500,
    modePaiement: "Mobile Money",
...
export const STATUT_COMMANDE = {
  "en attente": { label: "En attente",  bg: "bg-gray-100",  text: "text-gray-600",  dot: "bg-gray-400",  step: 0 },
  "en cours":   { label: "En cours",    bg: "bg-blue-50",   text: "text-blue-700",  dot: "bg-blue-500",  step: 1 },
  "expédié":    { label: "Expédié",     bg: "bg-amber-50",  text: "text-amber-700", dot: "bg-amber-500", step: 2 },
  "livré":      { label: "Livré",       bg: "bg-green-50",  text: "text-green-700", dot: "bg-green-500", step: 3 },
  "annulé":     { label: "Annulé",      bg: "bg-red-50",    text: "text-red-600",   dot: "bg-red-500",   step: -1 },
};

export const FRAIS_LIVRAISON = 1500;

export function calcTotal(items, frais = FRAIS_LIVRAISON) {
  const sousTotal = items.reduce((s, i) => s + i.prixUnit * i.quantite, 0);
  return { sousTotal, fraisLivraison: frais, total: sousTotal + frais };
}
